        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 h-full w-full sm:w-[450px] lg:w-[550px] glass-card border-l border-border-glass bg-bg-glass-heavy/95 backdrop-blur-3xl z-[9999] flex flex-col shadow-2xl overflow-hidden"
            >
              {/* Header */}
              <div className="flex justify-between items-start p-6 pt-10 lg:pt-12 border-b border-border-glass bg-background/40">
                <div>
                ...
                <button 
                  onClick={onClose}
                  className="p-2.5 bg-background/60 hover:bg-bg-glass rounded-full border border-border-glass transition-all group shadow-sm active:scale-95"
              ...
              <div className="p-6 border-t border-border-glass bg-background/80">
                <Link 
                  href={`/expose/${entityId}`}
                  className="w-full py-4 bg-foreground text-background text-[11px] font-black uppercase tracking-[0.2em] rounded-xl hover:bg-accent-crimson hover:text-white transition-all shadow-lg hover:shadow-glow-crimson flex justify-center items-center gap-2"
                >
