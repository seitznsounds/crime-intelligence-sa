...
import { Brain, Activity, Target, ShieldAlert, Zap, ChevronRight, AlertTriangle, Network, TrendingUp } from "lucide-react";
                ...
                <div className="flex-1 pr-4">
                  ...
                  <div className="flex items-center gap-8">
                    ...
                    <div className="hidden sm:block pl-6 border-l border-border-glass">
                      <p className="text-[10px] font-bold text-muted-foreground uppercase mb-2">Link Velocity</p>
