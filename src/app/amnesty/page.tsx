...
const AMNESTY_APPS = [
  { id: "APP_01", name: "Eugene de Kock", group: "SAPS / Vlakplaas", decision: "partial", disclosure: true, motive: "Suppression of anti-apartheid activists and protection of state security.", crime: "Multiple counts of murder, abduction, and torture including the Motherwell bombing.", hearing: "Pretoria, 1997-1998" },
  { id: "APP_02", name: "Clive Derby-Lewis", group: "Conservative Party", decision: "refused", disclosure: false, motive: "Triggering a racial civil war to prevent the 1994 elections.", crime: "Assassination of Chris Hani in April 1993.", hearing: "Johannesburg, 1997" },
  { id: "APP_03", name: "Janusz Waluś", group: "Conservative Party", decision: "refused", disclosure: false, motive: "Triggering a racial civil war to prevent the 1994 elections.", crime: "Assassination of Chris Hani in April 1993.", hearing: "Johannesburg, 1997" }
];

type AmnestyApp = typeof AMNESTY_APPS[0];
      ...
      actions={
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input type="text" placeholder="Search applicant..." className="bg-bg-glass border border-border-glass rounded-xl py-2.5 pl-10 pr-5 text-[12px] text-foreground placeholder:text-muted-foreground/40 focus:border-accent-blue/40 outline-none w-52" />
          </div>
