...
export default function AmnestyPage() {
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden selection:bg-accent-blue/30 transition-colors duration-300">
      {/* Forensic Backdrop */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,var(--accent-blue-opacity),transparent_50%)]" />
      ...
      <div className="container py-20 relative z-10 max-w-6xl">
        <header className="mb-16 flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="text-4xl font-bold tracking-tighter uppercase text-foreground">Amnesty Tracker</h1>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
             <div className="relative">
                ...
                <input 
                  ...
                  className="bg-bg-glass-heavy border border-border-glass rounded-xl py-3 pl-10 pr-6 text-[10px] font-mono text-foreground placeholder:text-muted-foreground/30 focus:border-accent-blue/40 outline-none transition-all w-64"
                />
             </div>
             <button className="p-3 bg-bg-glass border border-border-glass rounded-xl hover:bg-bg-glass-heavy transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          {[
            { label: "Applications Processed", value: "7,112", icon: <FileText className="w-4 h-4 text-muted-foreground/40" /> },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-4">
              {AMNESTY_APPS.map((app, i) => (
                <motion.div 
                  ...
                  className={`glass-card p-8 border-border-glass bg-bg-glass hover:bg-bg-glass-bright cursor-pointer transition-all flex flex-col md:flex-row justify-between items-start md:items-center gap-6 group ${selectedApp?.id === app.id ? 'border-accent-blue/40 bg-accent-blue/[0.02]' : ''}`}
                >
                  <div className="flex-1">
                    <div className="flex items-center gap-4 mb-2">
                       <h4 className="text-xl font-bold tracking-tighter uppercase text-foreground">{app.name}</h4>
                       <span className="text-[9px] font-mono text-muted-foreground uppercase tracking-widest px-2 py-0.5 border border-border-glass rounded">{app.group}</span>
                    </div>
                    <p className="text-[10px] text-muted-foreground leading-relaxed font-light line-clamp-1 italic">
                      "{app.crime}"
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-8">
                     <div className="text-right">
                        <p className="text-[8px] font-bold text-muted-foreground uppercase tracking-widest mb-1 text-right">Disclosure</p>
          ...
          <div className="space-y-8">
                ...
                {[
                  ...
                  <div key={i} className="space-y-3">
                    <div className="flex justify-between items-center text-[9px] font-bold">
                      ...
                      <span className="text-muted-foreground/40 font-mono">{item.value}</span>
                    </div>
            ...
            <div className="glass-card p-8 border-accent-blue/20 bg-accent-blue/[0.01]">
              ...
              <button className="w-full py-4 bg-bg-glass border border-border-glass text-foreground text-[10px] font-bold uppercase tracking-[0.2em] rounded-xl hover:bg-accent-blue hover:text-white transition-all">
              ...
              >
                ...
                <div className="space-y-10">
                  <div>
                    ...
                    <h2 className="text-5xl font-bold tracking-tighter uppercase mb-2 leading-none text-foreground">{selectedApp.name}</h2>
                    <p className="text-lg font-mono text-muted-foreground uppercase tracking-widest">Affiliation: {selectedApp.group}</p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-8">
                       ...
                       <div className="glass-card p-6 border-border-glass bg-bg-glass">
                          <p className="text-[9px] font-bold text-muted-foreground uppercase tracking-widest mb-2">Hearing Location</p>
                          <p className="text-xl font-bold font-mono tracking-tighter text-foreground">{selectedApp.hearing}</p>
                       </div>
                    </div>
                    ...
                    <div className="space-y-8">
                       <div className="p-8 bg-accent-blue/5 border border-accent-blue/20 rounded-3xl">
                          ...
                          <p className="text-xs text-foreground/80 leading-relaxed font-light font-mono uppercase tracking-tight">
                            {selectedApp.motive}
                          </p>
                       </div>
                       <div className="p-6 bg-bg-glass border border-border-glass rounded-2xl flex items-center justify-between">
                          <p className="text-[9px] font-bold text-muted-foreground uppercase tracking-widest">Full Disclosure Criteria</p>
                  ...
                  <button className="w-full py-5 bg-foreground text-background text-[10px] font-bold uppercase tracking-[0.2em] rounded-2xl hover:bg-accent-blue hover:text-white transition-all shadow-glow">
