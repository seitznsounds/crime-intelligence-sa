...
const AUDITS = [
  { id: "AUDIT_01", name: "SAPS (South African Police Service)", sector: "security", decay: 9.2, status: "unreformed", violations: ["Systemic Torture", "Vlakplaas Death Squads", "Impunity Culture"], echo: "Modern police brutality and the 'docket disappearance' phenomenon are direct cultural descendants of the SAP's operational methods.", desc: "The TRC found that the police were the primary instruments of state-sponsored terror. The failure to root out the 'impunity culture' has led to the current crisis in law enforcement." },
  { id: "AUDIT_02", name: "SADF (South African Defence Force)", sector: "security", decay: 8.4, status: "unreformed", violations: ["Cross-border Terrorism", "Surveillance", "Militarization"], echo: "The secretive nature of SADF operations provided a blueprint for modern-day opaque procurement and intelligence overreach.", desc: "Heavily involved in destabilizing Southern Africa. Volume 4 details the total militarization of the apartheid state and its lasting impact on regional security." },
  { id: "AUDIT_03", name: "Department of Justice", sector: "judiciary", decay: 6.1, status: "partially_reformed", violations: ["Judicial Negligence", "Legalized Discrimination"], echo: "The historical failure to protect citizens' rights has created a judiciary that is often perceived as sluggish in tackling political corruption.", desc: "The legal hearings explored how the judiciary largely upheld discriminatory laws and failed to intervene in cases of gross human rights violations." }
];

type Audit = typeof AUDITS[0];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
        ...
        <div className="space-y-6">
          <div className="glass-card p-6 border-border-glass bg-bg-glass">
            ...
            <div className="space-y-6">
              {[{ label: "SAPS Culture", decay: 9.2, status: "CRITICAL" }, { label: "SADF Opaque Ops", decay: 8.4, status: "SEVERE" }, { label: "Judicial Sluggishness", decay: 6.1, status: "MODERATE" }].map((item, i) => (
